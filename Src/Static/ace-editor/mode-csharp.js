...
var CSharpHighlightRules = function() {
    var keywordMapper = this.createKeywordMapper({
        ...
        "keyword": "abstract|event|new|struct|as|explicit|null|switch|base|extern|object|this|bool|false|operator|throw|break|finally|out|true|byte|fixed|override|try|case|float|params|typeof|catch|for|private|uint|char|foreach|protected|ulong|checked|goto|public|unchecked|class|if|readonly|unsafe|const|implicit|ref|ushort|continue|in|return|using|decimal|int|sbyte|virtual|default|interface|sealed|volatile|delegate|internal|short|void|do|is|sizeof|while|double|lock|stackalloc|else|long|static|enum|namespace|string|var|dynamic|yield|get|set|async|await|partial|value",
    ...
    this.$rules = {
        "start" : [
            ...
            DocCommentHighlightRules.getStartRule("doc-start"),
            {
                ...
                regex : "[+-]?\\d+(?:(?:\\.\\d*)?(?:[eE][+-]?\\d+)?)?([mMfFdDuUlL]|[uU][lL])?\\b"
            }, {
